...
REST_FRAMEWORK = {
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': (
        'rest_framework.authentication.SessionAuthentication',              #DRF
        'rest_framework.authentication.BasicAuthentication',                #DRF
        'rest_framework_jwt.authentication.JSONWebTokenAuthentication',     #DRF
        'conduit.apps.authentication.backends.JWTAuthentication',           #Postman
    ),
