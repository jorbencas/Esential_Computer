...
from .views import (
    ...
    CommentViewSet, TagViewSet, ArticleViewSet1
)

router = DefaultRouter(trailing_slash=False)
router.register(r'articles', ArticleViewSet)    #AngularJS
router.register(r'articles1', ArticleViewSet1)  #DRF
router.register(r'comments1', CommentViewSet)   #DRF
router.register(r'tags1', TagViewSet)           #DRF
